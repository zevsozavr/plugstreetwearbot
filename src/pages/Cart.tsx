          ...
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
              {items.map((item) => {
                ...
                return (
                  <Glass card key={key} style={{ display: 'flex', gap: 16, padding: 16, borderRadius: 'var(--rounded-2xl)', alignItems: 'stretch' }}>
                    <div style={{ width: 96, height: 128, flexShrink: 0, borderRadius: 'var(--rounded-xl)', overflow: 'hidden', background: 'var(--surface-low)', border: '1px solid rgba(255,255,255,0.04)' }}>
            ...
            <Glass card style={{ padding: 24, borderRadius: 'var(--rounded-2xl)', marginTop: 32 }}>
              <h3 style={{ font: 'var(--font-label-lg)', textTransform: 'uppercase', letterSpacing: '0.15em', borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: 12, marginBottom: 16 }}>{t('cart.summary')}</h3>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 16, marginBottom: 24 }}>
